...
# Paquetes necesarios
required_packages <- c("tidyverse", "countrycode", "moments", "stargazer", "scales", "corrplot")
...
# Calcular la variable 'internet_num' en el dataset principal
datos_facebook_extendido <- datos_facebook %>%
  mutate(internet_num = internet_por_num * poblacion_num / 100) # CAMBIO: Calcular internet_num para todo el dataset

# Matriz de correlaciones para 2010
datos_correlacion_2010 <- datos_facebook_extendido %>% # CAMBIO: Usar el dataset extendido con 'internet_num'
  filter(anyo == 2010) %>%
  dplyr::select(facebook_num, internet_por_num, poblacion_num, internet_num, facebook_por_num, facebook_por_internet) # CAMBIO: Añadir variables solicitadas y facebook_por_num

matriz_correlacion_2010 <- cor(datos_correlacion_2010, use = "pairwise.complete.obs")
print("Matriz de Correlaciones para 2010:")
print(matriz_correlacion_2010)

# Visualización del mapa de calor para 2010
print("Mapa de calor de Correlaciones para 2010:")
corrplot::corrplot(matriz_correlacion_2010,
                   method = "color",
                   type = "upper",
                   order = "hclust",
                   tl.col = "black",
                   ...
                   diag = FALSE,
                   title = "Correlaciones de Variables Numéricas - Año 2010") # CAMBIO: Añadir título al plot de 2010


# Matriz de correlaciones para 2023
datos_correlacion_2023 <- datos_facebook_extendido %>% # CAMBIO: Usar el dataset extendido con 'internet_num'
  filter(anyo == 2023) %>%
  dplyr::select(facebook_num, internet_por_num, poblacion_num, internet_num, facebook_por_num, facebook_por_internet) # CAMBIO: Añadir variables solicitadas y facebook_por_num

matriz_correlacion_2023 <- cor(datos_correlacion_2023, use = "pairwise.complete.obs")
print("Matriz de Correlaciones para 2023:")
print(matriz_correlacion_2023)

# Visualización del mapa de calor para 2023
print("Mapa de calor de Correlaciones para 2023:")
corrplot::corrplot(matriz_correlacion_2023,
                   method = "color",
                   type = "upper",
                   order = "hclust",
                   tl.col = "black",
                   ...
                   col = colorRampPalette(c("red", "white", "green"))(200),
                   diag = FALSE,
                   title = "Correlaciones de Variables Numéricas - Año 2023") # CAMBIO: Añadir título al plot de 2023
```

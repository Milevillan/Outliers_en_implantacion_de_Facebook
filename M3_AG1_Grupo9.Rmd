...
Algunos motivos que hayan podido llevar a errores de medición: el más claro, falta de recursos del país y los organismos que recopilan esta información, para realizar buenas estimaciones del uso de internet. Por otro lado, por motivos culturales y socioeconómicos puede haber una mayor tendencia al uso compartido de dispositivos o cuentas, o el acceso a internet en puntos comunitarios, lo que podría inflar la cuenta de usuarios de una plataforma social en relación con los usuarios únicos de internet. 

Un segundo grupo está formado por países con una penetración de Facebook excepcionalmente alta respecto a los usuarios de Internet, rozando la saturación; Chile 2010 con un 98.94% es un ejemplo de esta alta adopción que lo desvía de la tendencia general. Es posible que el fenómeno sea similar al anterior, aunque en este caso no caiga en una inconsistencia lógica.
...
Este último grupo se podría explicar principalmente por la existencia de otros servicios análogos, que tuvieron una expansión y penetración mayor en estos países: Cyworld en Corea y Line en Japón (fuentes: [Language Trainers](https://www.languagetrainers.com/blog/a-guide-to-social-media-in-south-korea-facebook-twitter-and-other-sites/) y [JapanBuzz](https://www.japanbuzz.info/social-media-in-japan/)).
...
La reducción del residual std. error confirma que los modelos robustos en este caso logran un mejor ajuste a la mayoría de los datos al minimizar la influencia de las observaciones atípicas.
...
Nota: para esta respuesta hemos consultado este [artículo](https://fastercapital.com/content/Lookahead-bias-in-machine-learning--Enhancing-predictive-models.html#Understanding-lookahead-bias-in-machine-learning), donde se trata el problema de modelizar (aunque se refiere a modelos de machine learning), incluyendo datos del futuro.
